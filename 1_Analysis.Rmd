...
save(meta_pver, file = "meta_pver.RData")
...
ord_pver_full <- dbrda(dist_pver_ordered ~ Lat + Long + MMM + Depth + catBleaching + DHW2020 + maxDHW + Kd_490, data = meta_pver)

sort(vif.cca(ord_pver_full)) 
  #     Depth catBleaching       maxDHW      DHW2020         Long          Lat 
   # 1.095734     1.110180     2.884414     3.663767    10.442204    20.729312 
  #       MMM    Chl_a_sum       Kd_490 
  # 31.698438    51.591898    57.896562 
...
ord_pver <- dbrda(dist_pver_ordered ~ maxDHW + Lat + Depth + catBleaching + DHW2020 + Kd_490, data = meta_pver)

sort(vif.cca(ord_pver)) 
    #   Depth catBleaching       maxDHW       Kd_490          Lat      DHW2020 
 #   1.042940     1.088547     1.503779     1.834879     2.844377     3.114021 
...
#Model: dbrda(formula = dist_pver_ordered ~ Lat + DHW2020 + Kd_490, data = meta_pver)
     #     Df SumOfSqs      F Pr(>F)   
#Lat        1   0.0735 2.8782  0.013 * 
#DHW2020    1   0.0509 1.9941  0.067 . 
#Kd_490     1   0.0786 3.0778  0.010 **
#Residual 148   3.7811       


R2adj <- RsquareAdj(ord_pver)$adj.r.squared
R2adj 
#[1] 0.03517611
...
varp <- varpart(dist_pver_ordered, ~Lat, ~Kd_490, data = meta_pver)
plot(varp, digits = 2, Xnames = c("Lat", "KD 490"), bg = c("navy", "tomato", "green"))
...
save(acro_k2, file = "acro_k2.RData")
...
load("ind_coords.pmea.RData")
load("ind_coords.pver.RData")
```
